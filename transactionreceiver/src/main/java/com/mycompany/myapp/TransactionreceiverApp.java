...
public class TransactionreceiverApp {

    private static final Logger log = LoggerFactory.getLogger(TransactionreceiverApp.class);

    private final Environment env;

    public TransactionreceiverApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes transactionreceiver.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(TransactionreceiverApp.class);
